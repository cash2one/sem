...
class CI_DB_active_record extends CI_DB_driver {
    ...
    public function on_duplicate_batch($table = '', $set = NULL)
    {
        if ( ! is_null($set))
        {
            $this->set($set);
        ...
        $sql = $this->_duplicate_insert_batch($this->_protect_identifiers($this->dbprefix.$table), $this->ar_set);
	...
	public function get_compile_select($table = '', $limit = null, $offset = null) {
		if (!empty($table)) {
			$this->_track_aliases($table);
			$this->from($table);
		}
