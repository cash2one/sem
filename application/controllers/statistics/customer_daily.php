 ...
 * 用户的竞价相关统计 
 */
class Customer_daily extends CI_Controller {
    ...
    public function index($date=NULL)
    {
        ...
        // 开启竞价时间信息
        $activate_bid_info = $this->day_report_service->get_activate_bid_info();
...
/* End of file customer_daily.php */
/* Location: ./application/controllers/statistics/customer_daily.php */
