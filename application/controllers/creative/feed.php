...
class Feed extends CI_Controller {
    ...
    private function _init() {
        ...
        (!empty($_REQUEST['order_type']) && in_array(trim($_REQUEST['order_type']), array('asc','desc'))) &&
            $this->order_type = trim($_REQUEST['order_type']);
    ...
    public function index() {
        ...
        $list = $this->creative_service->get_list($params);

        $c_params = array();
        !empty($this->unit_id) && $c_params['unit_id'] = $this->unit_id;
        $item_count = $this->creative_service->get_list_count($c_params);
