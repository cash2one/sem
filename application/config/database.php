...
$db['master']['hostname'] = '172.16.34.145';
$db['master']['username'] = 'sqhworker';
$db['master']['password'] = 'sqhworker';
$db['master']['database'] = 'sem_temp';
...
$db['slave']['hostname'] = '172.16.34.145';
$db['slave']['username'] = 'sqhworker';
$db['slave']['password'] = 'sqhworker';
$db['slave']['database'] = 'sem_temp';
