<?php /* Smarty version Smarty-3.1.14, created on 2014-06-30 16:24:44
         compiled from "/home/dingz/sem/trunk/application/views/smarty/templates/login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:214706700953916ebded12e4-24048951%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0e42a44cd5fd88763b2314bbf9c9168f5f3f863' => 
    array (
      0 => '/home/dingz/sem/trunk/application/views/smarty/templates/login.tpl',
      1 => 1402039363,
      2 => 'file',
    ),
    'c03b81b6513e599013546e1657b3a85b08ed9603' => 
    array (
      0 => '/home/dingz/sem/trunk/application/views/smarty/templates/base.tpl',
      1 => 1402039363,
      2 => 'file',
    ),
    '9a35bb7e01b8f8e910b500ae0a10a6e6bd507016' => 
    array (
      0 => '/home/dingz/sem/trunk/application/views/smarty/templates/functions.tpl',
      1 => 1404116669,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '214706700953916ebded12e4-24048951',
  'function' => 
  array (
    'header' => 
    array (
  ...
  'unifunc' => 'content_53916ebe0dad01_19800973',
  'variables' => 
  array (
    'environment' => 0,
    'version' => 0,
...
<?php if ($_valid && !is_callable('content_53916ebe0dad01_19800973')) {function content_53916ebe0dad01_19800973($_smarty_tpl) {?><?php /*  Call merged included template "functions.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("functions.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 1, '214706700953916ebded12e4-24048951');
content_53b11eccb87400_75298797($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "functions.tpl" */?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    ...
    <link href="/static/??plugins/bootstrap/css/bootstrap.css,plugins/jquery-tags-input/jquery.tagsinput.css,plugins/bootstrap-daterangepicker/daterangepicker.css,plugins/bootstrap-modal/css/bootstrap-modal.css,css/csem.css?v=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
" rel="stylesheet" type="text/css"/>
    ...
    <link href="/static/css/csem.css?v=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
" rel="stylesheet" type="text/css"/>
    <?php }?>

    <!--link rel="shortcut icon" href="/static/favicon.ico" /-->
</head>
<body class="page-header-fixed login-body">
...
<script type="text/javascript" src="/static/scripts/area.js?v=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
<script type="text/javascript" src="/static/scripts/base.js?v=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>
<?php }?>

<script type="text/javascript" src="/static/scripts/login.js?v=<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
"></script>


</body>
</html>
<?php }} ?><?php /* Smarty version Smarty-3.1.14, created on 2014-06-30 16:24:44
         compiled from "/home/dingz/sem/trunk/application/views/smarty/templates/functions.tpl" */ ?>
<?php if ($_valid && !is_callable('content_53b11eccb87400_75298797')) {function content_53b11eccb87400_75298797($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_header')) {
    function smarty_template_function_header($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['header']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
...
<?php if (!function_exists('smarty_template_function_loginheader')) {
    function smarty_template_function_loginheader($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['loginheader']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
<div class="header navbar">
    <!-- BEGIN TOP NAVIGATION BAR -->
    <div class="navbar-inner">
...
<?php if (!function_exists('smarty_template_function_footer')) {
    function smarty_template_function_footer($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['footer']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
<!-- BEGIN FOOTER -->
...
<?php if (!function_exists('smarty_template_function_myleft')) {
    function smarty_template_function_myleft($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['myleft']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
<div class="cleft">
    <div class="portlet blue">
        ...
        <div class="portlet-body">
            <ul class="tree set-nav">
                <li><p <?php if ($_smarty_tpl->tpl_vars['focus']->value==0){?>class="on"<?php }?>><a href="/page/change_info">修改用户信息</a></p></li>
                <li><p <?php if ($_smarty_tpl->tpl_vars['focus']->value==1){?>class="on"<?php }?>><a href="/page/change_pwd">修改密码</a></p></li>
                <li><p <?php if ($_smarty_tpl->tpl_vars['focus']->value==2){?>class="on"<?php }?>><a href="/page/customer_access">客服授权</a></p></li>
            </ul>
        </div>
    </div>
</div>
...
<?php if (!function_exists('smarty_template_function_helpleft')) {
    function smarty_template_function_helpleft($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['helpleft']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
<div class="cleft help-nav">
	<div class="box" id="help_tree" >
		...
		<div class="portlet-body">
			<ul class="help-tree">
				<li class="bid-icon add <?php if ($_smarty_tpl->tpl_vars['page']->value=='add'){?>on<?php }?>">
					<a href="/page/help">添加竞价词</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon del <?php if ($_smarty_tpl->tpl_vars['page']->value=='del'){?>on<?php }?>">
					<a href="/page/help_del">删除竞价词</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon modify <?php if ($_smarty_tpl->tpl_vars['page']->value=='modify'){?>on<?php }?>">
					<a href="/page/help_modify">修改竞价设置</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon status <?php if ($_smarty_tpl->tpl_vars['page']->value=='status'){?>on<?php }?>">
					<a href="/page/help_status">修改竞价状态</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon tag <?php if ($_smarty_tpl->tpl_vars['page']->value=='tag'){?>on<?php }?>">
					<a href="/page/help_tag">分组管理</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon rank <?php if ($_smarty_tpl->tpl_vars['page']->value=='rank'){?>on<?php }?>">
					<a href="/page/help_rank">实时排名</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon monitor <?php if ($_smarty_tpl->tpl_vars['page']->value=='monitor'){?>on<?php }?>">
					<a href="/page/help_monitor">排名监控</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon feedback <?php if ($_smarty_tpl->tpl_vars['page']->value=='feedback'){?>on<?php }?>">
					<a href="/page/help_feedback">竞价反馈</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon log <?php if ($_smarty_tpl->tpl_vars['page']->value=='log'){?>on<?php }?>">
					<a href="/page/help_log">竞价日志</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon white-list <?php if ($_smarty_tpl->tpl_vars['page']->value=='white_list'){?>on<?php }?>">
					<a href="/page/help_white_list">设置白名单</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon bid <?php if ($_smarty_tpl->tpl_vars['page']->value=='bid'){?>on<?php }?>">
					<a href="/page/help_bid">24小时竞价</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon sync <?php if ($_smarty_tpl->tpl_vars['page']->value=='sync'){?>on<?php }?>">
					<a href="/page/help_sync">数据同步</a>
					<span class="arrow"></span>
				</li>
				<li class="bid-icon accounts <?php if ($_smarty_tpl->tpl_vars['page']->value=='accounts'){?>on<?php }?>">
...
<?php if (!function_exists('smarty_template_function_help_service')) {
    function smarty_template_function_help_service($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['help_service']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
<div class="service">
	<ul>
...
<?php if (!function_exists('smarty_template_function_errTipsLayer')) {
    function smarty_template_function_errTipsLayer($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['errTipsLayer']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_modal_accounterror')) {
    function smarty_template_function_modal_accounterror($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['modal_accounterror']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_update_account')) {
    function smarty_template_function_update_account($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['update_account']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_white_list')) {
    function smarty_template_function_white_list($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['white_list']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_modal')) {
    function smarty_template_function_modal($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['modal']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_pager')) {
    function smarty_template_function_tpl_pager($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_pager']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
        ...
        <div class="pager-box"> 
			...
			<a class="buy-open">竞价词不够用？马上升级竞价词数！</a>
			<ul>
...
<?php if (!function_exists('smarty_template_function_tpl_modalHint')) {
    function smarty_template_function_tpl_modalHint($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_modalHint']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_more100')) {
    function smarty_template_function_tpl_more100($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_more100']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_checkMore100')) {
    function smarty_template_function_tpl_checkMore100($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_checkMore100']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_keepKeywords')) {
    function smarty_template_function_tpl_keepKeywords($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_keepKeywords']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_modal_handle')) {
    function smarty_template_function_tpl_modal_handle($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_modal_handle']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_service')) {
    function smarty_template_function_tpl_service($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_service']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_change_hzuser')) {
    function smarty_template_function_tpl_change_hzuser($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_change_hzuser']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_smart_bid')) {
    function smarty_template_function_smart_bid($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['smart_bid']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
	<div class="tab-list">
		<ul id="tagMenu">
		</ul>
...
<?php if (!function_exists('smarty_template_function_tpl_smartBidList')) {
    function smarty_template_function_tpl_smartBidList($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_smartBidList']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_modal_open_bid')) {
    function smarty_template_function_tpl_modal_open_bid($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_modal_open_bid']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_calc_bid')) {
    function smarty_template_function_calc_bid($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['calc_bid']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_monitor_set')) {
    function smarty_template_function_monitor_set($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['monitor_set']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_newTag')) {
    function smarty_template_function_tpl_newTag($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_newTag']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_tagList')) {
    function smarty_template_function_tpl_tagList($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_tagList']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_whiteList')) {
    function smarty_template_function_tpl_whiteList($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_whiteList']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_area')) {
    function smarty_template_function_tpl_area($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_area']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_competitorList')) {
    function smarty_template_function_tpl_competitorList($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_competitorList']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_initUserData')) {
    function smarty_template_function_tpl_initUserData($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_initUserData']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_competitor_open')) {
    function smarty_template_function_tpl_competitor_open($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_competitor_open']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_competitor_rank_tpl')) {
    function smarty_template_function_competitor_rank_tpl($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['competitor_rank_tpl']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_bid_24_tpl')) {
    function smarty_template_function_bid_24_tpl($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['bid_24_tpl']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_photo')) {
    function smarty_template_function_tpl_photo($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_photo']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_add_bidKeyword')) {
    function smarty_template_function_tpl_add_bidKeyword($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_add_bidKeyword']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_chooseKeyword')) {
    function smarty_template_function_tpl_chooseKeyword($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_chooseKeyword']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<div id="chooseKeyword" class="modal modal-bid hide" data-backdrop="static" data-width="560">
	...
	<div class="modal-body no-padding">
		<div class="keyword-count">
			...
			<p>
				<a class="buy-open">竞价词不够用？立即升级竞价词！</a>
...
<?php if (!function_exists('smarty_template_function_tpl_bidRegion')) {
    function smarty_template_function_tpl_bidRegion($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_bidRegion']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_tpl_questionnaire')) {
    function smarty_template_function_tpl_questionnaire($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['tpl_questionnaire']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
...
<?php if (!function_exists('smarty_template_function_smart_template')) {
    function smarty_template_function_smart_template($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['smart_template']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
    foreach ($params as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);}?>
	<?php smarty_template_function_bid_24_tpl($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_questionnaire($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_initUserData($_smarty_tpl,array());?>

	<?php smarty_template_function_white_list($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_modalHint($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_smartBidList($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_competitorList($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_pager($_smarty_tpl,array());?>

	<?php smarty_template_function_calc_bid($_smarty_tpl,array());?>

    <?php smarty_template_function_tpl_modal_open_bid($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_modal_handle($_smarty_tpl,array());?>

	<?php smarty_template_function_modal($_smarty_tpl,array());?>

	<?php smarty_template_function_monitor_set($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_whiteList($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_newTag($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_tagList($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_area($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_competitor_open($_smarty_tpl,array());?>

	<?php smarty_template_function_competitor_rank_tpl($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_photo($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_add_bidKeyword($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_chooseKeyword($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_bidRegion($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_more100($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_keepKeywords($_smarty_tpl,array());?>

	<?php smarty_template_function_tpl_checkMore100($_smarty_tpl,array());?>
