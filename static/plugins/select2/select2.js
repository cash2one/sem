...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "没有匹配内容"; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "请输入" + n + "个或更多字符" + (n == 1? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "请删除" + n + "个字符" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "你只能选择" + limit + "个条目" + (limit == 1 ? "" : "s"); },
